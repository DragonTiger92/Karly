import"./style-4crV3qMT.js";import{p as y,a as u,g as S}from"./header-BGP4sVp0.js";import"./footer-B0-mmy3R.js";import{c as M,i as v,g as A,a}from"./checkLogin-UNDA_AzC.js";import{s as T}from"./setDocumentTitle-CYsy-ZvK.js";/* empty css               */import"./setDefaultData--EtDcv58.js";T("칼리 | 장바구니");M();const H=await y.collection("products").getFullList({filter:'package_type~"냉장"'}),N=await y.collection("products").getFullList({filter:'package_type~"냉동"'}),$=await y.collection("products").getFullList({filter:'package_type~"상온"'});H.forEach(e=>{v(".cart_content_list_1",k(e))});N.forEach(e=>{v(".cart_content_list_2",k(e))});$.forEach(e=>{v(".cart_content_list_3",k(e))});function k(e){return`
      <li>
